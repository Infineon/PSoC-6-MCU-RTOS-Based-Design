...
#define ORIENTATION_TYPES 6    

/* Background image */
extern cy_eink_image_t const background[CY_EINK_FRAME_SIZE];
/* Orienation image*/
extern cy_eink_image_t const orientationImages[ORIENTATION_TYPES][CY_EINK_FRAME_SIZE];
