...
/* Functions that start and control the timers used for LED blink / toggle
   intervals */
void static StatusLedRedTimerStart(void);
void static StatusLedOrangeTimerStart(void);
void static StatusLedRedTimerUpdate(TickType_t period);
void static StatusLedOrangeTimerUpdate(TickType_t period);
        ...
        if(rtosApiResult == pdTRUE)
        {
            ...
            switch(statusLedData.orangeLed)
            {
                ...
                case LED_TIMER_EXPIRED:
                    ...
                    {
                        /* Toggle the LED */
                        Cy_GPIO_Inv(Pin_LED_Orange_0_PORT,
                                    Pin_LED_Orange_0_NUM);
                    }
                    else if (orangeLedState == LED_BLINK_ONCE)
                    {
                        /* Turn off the LED */
                        Cy_GPIO_Set(Pin_LED_Orange_0_PORT,
                                    Pin_LED_Orange_0_NUM);
                        /* Set the timer to idle mode */
                        StatusLedOrangeTimerUpdate(STATUS_LED_IDLE_INTERVAL);
                        orangeLedState = LED_TURN_OFF;
            ...
            switch(statusLedData.redLed)
            {
                ...
                /* Turn ON the LED */
                case LED_TURN_ON:
                    Cy_GPIO_Clr(Pin_LED_Red_0_PORT,Pin_LED_Red_0_NUM);
                    /* Set the timer to idle mode */
                ...
                /* Turn OFF the LED */        
                case LED_TURN_OFF:
                    Cy_GPIO_Set(Pin_LED_Red_0_PORT,Pin_LED_Red_0_NUM);
                    /* Set the timer to idle mode */
                    StatusLedRedTimerUpdate(STATUS_LED_IDLE_INTERVAL);
                ...
                case LED_TIMER_EXPIRED:
                    ...
                    {
                        /* Toggle the LED */
                        Cy_GPIO_Inv(Pin_LED_Red_0_PORT,
                                    Pin_LED_Red_0_NUM);
                    }
                    else if (redLedState == LED_BLINK_ONCE)
                    {
                        /* Turn off the LED */
                        Cy_GPIO_Set(Pin_LED_Red_0_PORT,
                                    Pin_LED_Red_0_NUM);
                        /* Set the timer to idle mode */
                        StatusLedRedTimerUpdate(STATUS_LED_IDLE_INTERVAL);                        
                        redLedState = LED_TURN_OFF;
...
/*******************************************************************************
* Function Name: void static StatusLedOrangeTimerCallback(TimerHandle_t xTimer)                          
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void static StatusLedOrangeTimerCallback(TimerHandle_t xTimer)
{
    /* Variable used to store the return values of RTOS APIs */
    BaseType_t rtosApiResult;
...
/*******************************************************************************
* Function Name: void static StatusLedOrangeTimerStart(void)                 
********************************************************************************
* Summary:
...
/*******************************************************************************
* Function Name: void static StatusLedOrangeTimerUpdate(TickType_t period)                
********************************************************************************
* Summary:
...
/*******************************************************************************
* Function Name: void static StatusLedRedTimerCallback(TimerHandle_t xTimer)                          
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void static StatusLedRedTimerCallback(TimerHandle_t xTimer)
{
    /* Variable used to store the return values of RTOS APIs */
    BaseType_t rtosApiResult;
...
/*******************************************************************************
* Function Name: void static StatusLedRedTimerStart(void)                   
********************************************************************************
* Summary:
...
/*******************************************************************************
* Function Name: void static StatusLedRedTimerUpdate(TickType_t period)                 
********************************************************************************
* Summary:
*  This function updates the timer period per the parameter
*
